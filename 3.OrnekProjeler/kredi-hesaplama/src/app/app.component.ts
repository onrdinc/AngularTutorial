...
export class AppComponent {
  ...
  //this sadece classın altında bir şeye ulaşmak istenildiğinde kullanılır
  hesapla() {
    var taksitTutari: number = (this.krediTutari / this.taksitSayisi) * 1.29
    var toplamGeriOdeme: number = taksitTutari * this.taksitSayisi
